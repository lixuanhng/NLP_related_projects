...
def InputAdj(name=None, dtype=K.floatx(), sparse=False, tensor=None):
    # 外部只传入了 sparse=True
    shape = (None, None)
    input_layer = InputLayerAdj(batch_input_shape=shape, name=name, sparse=sparse,
                                input_dtype=dtype)
...
class InputLayerAdj(Layer):
    def __init__(self, input_shape=None, batch_input_shape=None, input_dtype=None,
